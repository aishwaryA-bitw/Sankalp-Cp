...
const LoginPage = () => {
  ...
  useEffect(() => {
    const fetchMasterData = async () => {
      const SCRIPT_URL = "https://script.google.com/macros/s/AKfycby0-aE9uNuU3yBJ9SAHvAfXycYt5vPyvAtlAauVy-xlH9rc4fPCGSQM6pvsqZ9QvSvbyg/exec"
      
      try {
        setIsDataLoading(true)
        
        // Get the spreadsheet ID from your Apps Script
        const SPREADSHEET_ID = "1gTDJigoeyXYzxR7HxDMwOjGL0hPP3Qc-P9HAChNCxUw"
