...
export default function AdminDashboard() {
  ...
  const fetchDepartmentData = async () => {
    ...
    try {
      ...
      // console.log(
      //   `Fetching data for dashboard type: ${dashboardType}, sheet: ${sheetName}`
      // );
      ...
      const processedRows = data.table.rows
        .map((row, rowIndex) => {
          ...
          //     `Row ${
          //       rowIndex + 1
          //     }: assignedTo="${assignedTo}", username="${username}", userRole="${userRole}", isMatch=${isUserMatch}`
          //   );
          // }
          ...
          // if (rowIndex <= 5) {
          //   console.log(
          //     `Row ${rowIndex + 1}: taskId="${taskId}" (type: ${typeof taskId})`
          //   );
          // }
          ...
          if (rowIndex <= 5) {
            console.log(
              `Row ${
                rowIndex + 1
              }: taskStartDateValue="${taskStartDateValue}", parsed="${taskStartDate}"`
            );
          }
          ...
          if (dashboardType === "delegation") {
            ...
            //     `Row ${
            //       rowIndex + 1
            //     }: taskStartDateObj=${taskStartDateObj}, today=${today}, tomorrow=${tomorrow}, isValid=${!!taskStartDateObj}`
            //   );
            // }
          ...
          //     `Row ${
          //       rowIndex + 1
          //     }: completionDateValue="${completionDateValue}", parsed="${completionDate}"`
          //   );
          // }
          ...
          //     `Row ${
          //       rowIndex + 1
          //     }: status="${status}", completionDate="${completionDate}", dashboardType="${dashboardType}"`
          //   );
          // }
    ...
    const viewFilteredTasks = filteredTasks.filter((task) => {
      ...
      switch (view) {
        ...
        case "overdue":
          ...
          return taskDate < today && !isDateToday(task.taskStartDate);
        default:
          return true;
      }
    });
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          {
            ...
            <div className="p-4">
              ...
              <p className="text-xs text-blue-600">Total Tasks (Till date)</p>
            </div>
          </div>
            )
          }
          ...
          {dashboardType === "delegation" && (
            <div className="rounded-lg border border-l-4 border-l-red-500 shadow-md hover:shadow-lg transition-all bg-white">
              <div className="flex flex-row items-center justify-between space-y-0 pb-2 bg-gradient-to-r from-red-50 to-red-100 rounded-tr-lg p-4">
                <h3 className="text-sm font-medium text-red-700">Total Pending Tasks</h3>
                <Clock className="h-4 w-4 text-red-500" />
              </div>
              <div className="p-4">
                <div className="text-3xl font-bold text-red-700">{departmentData.pendingDelegationTasks || 0}</div>
                <p className="text-xs text-red-600">Planned date set but not completed</p>
              </div>
            </div>
          )}
                      ...
                      <div className="grid gap-4 md:grid-cols-3">
                        ...
                        <div className="bg-white p-3 rounded-lg border border-green-200">
                          ...
                          <div className="text-xs text-green-600 mt-1">
                            {filteredDateStats.completedTasks} of{" "}
                            {filteredDateStats.totalTasks} tasks completed
                          </div>
                        </div>
                      </div>
                    </div>
                          ...
                          {dashboardType === "delegation"
                            ...
                            : `${
                                ...
                                dateRange.filtered
                                  ? filteredDateStats.totalTasks
                                  : departmentData.totalTasks
                              } tasks completed (including future dates)`}
                        </p>
                      </div>
                    </div>
                  </div>
                              ...
                              <div className="p-4 bg-gradient-to-r from-green-50 to-green-100 border-b border-green-200">
                                ...
                                <p className="text-sm text-green-600">
                                  {dashboardType === "delegation"
                                    ...
                                    : "Staff with high task completion rates (all tasks including future dates)"}
                                </p>
                              </div>
                              <div className="p-4">
                                <div className="space-y-4">
                                        ...
                                        <div className="flex items-center gap-2">
                                          ...
                                          <div>
                                            ...
                                            <p className="text-xs text-green-600">
                                              ...
                                              {staff.totalTasks} tasks completed
                                            </p>
                                          </div>
                                        </div>
                              ...
                              <div className="p-4 bg-gradient-to-r from-yellow-50 to-yellow-100 border-b border-yellow-200">
                                ...
                                <p className="text-sm text-yellow-600">
                                  {dashboardType === "delegation"
                                    ...
                                    : "Staff with moderate task completion rates (all tasks including future dates)"}
                                </p>
                              </div>
                              <div className="p-4">
                                <div className="space-y-4">
                              ...
                              <div className="p-4 bg-gradient-to-r from-red-50 to-red-100 border-b border-red-200">
                                ...
                                <p className="text-sm text-red-600">
                                  {dashboardType === "delegation"
                                    ...
                                    : "Staff with lower task completion rates (all tasks including future dates)"}
                                </p>
                              </div>
                              <div className="p-4">
                                <div className="space-y-4">
